export default {
  'account.settings.menuMap.basic': '常规设置',
  'account.settings.menuMap.security': '登陆设置',
  'account.settings.menuMap.binding': '账号绑定',
  'account.settings.menuMap.notification': '消息通知',
  'account.settings.menuMap.check-version': '检查更新',
